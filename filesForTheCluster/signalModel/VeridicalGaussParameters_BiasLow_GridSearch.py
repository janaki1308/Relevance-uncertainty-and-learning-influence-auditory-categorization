...
def write_into_file(std_sensory, fresult):
    ...
    guess_p_back = np.arange(0.05,1,0.1); guess_p_low = np.arange(0.6,0.81,0.05)
...
if __name__ == '__main__':
    ...
    os.chdir("/home/janakis/results/longContextLowFromProlific/veridicalGaussianParameters_gridSearch/")
