...
def MLE_fmin(params, fresultFile):
    log_prior_low_mean, log_prior_high_mean, log_prior_sigma, prob_back = [2.55,2.85,0.1,0.3]
...
if __name__ == '__main__':
    ...
    os.chdir("/home/janakis/results/noBiasFromProlific/veridicalGaussianParametersPback_finerOptimization/")
