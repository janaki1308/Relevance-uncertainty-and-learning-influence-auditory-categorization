...
def MLE_fmin(params, fresultFile):
    log_prior_low_mean, log_prior_high_mean, log_prior_sigma, prob_back = [2.55,2.85,0.1,0]
...
if __name__ == '__main__':
    ...
    os.chdir("/home/janakis/results/noBiasFromProlific/pback_lesionmodel/veridicalGaussParameters_finerOptimization/")
        
    """
    Subsampling trials and behaviour
    """    
    for iteration in np.arange(int(sys.argv[5]),int(sys.argv[6])):
