...
def write_into_file(lm_start, lm_end, hm_start, hm_end, std_sensory, fresult):
    ...
    guess_p_back = np.array([0]); guess_p_low = np.arange(0.2,0.41,0.05)
...
if __name__ == '__main__':
    ...
    os.chdir("/home/janakis/results/longContextHighFromProlific/pback_lesionmodel/sigmaSensoryPredetermined")
