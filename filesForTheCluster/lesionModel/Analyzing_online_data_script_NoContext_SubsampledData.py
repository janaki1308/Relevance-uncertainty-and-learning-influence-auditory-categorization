...
def subsampleLongContext(trial_behaviour_full, corrans_full, trial_tones_full):
    idxOfSubsampledData = np.random.choice(len(trial_behaviour_full), size=500, replace=False)
...
if __name__ == '__main__':
    ...
    os.chdir("/home/janakis/results/noBiasFromProlific/pback_lesionmodel/subsampledData/")
